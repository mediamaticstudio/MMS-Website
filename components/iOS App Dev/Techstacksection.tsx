...
import { Bird, Target, Wrench, Tent, Atom, Heart, Paintbrush, Smartphone, Flame, Cloud, Leaf, Hexagon, Hammer, PlaneTakeoff, Zap, Palette } from "lucide-react";
import type { LucideIcon } from "lucide-react";
import DigitalAuditModal from "@/components/DigitalAuditModal";

const techCategories: { category: string; items: { name: string; Icon: LucideIcon }[] }[] = [
    {
        category: "Languages",
        items: [
            { name: "Swift", Icon: Bird },
            { name: "Kotlin", Icon: Target },
            { name: "Objective-C", Icon: Wrench },
            { name: "Dart", Icon: Tent },
        ],
    },
    {
        ...
        items: [
            ...
            { name: "Flutter", Icon: Heart },
            { name: "SwiftUI", Icon: Paintbrush },
    ...
    },
    {
        ...
        items: [
            ...
            { name: "TestFlight", Icon: PlaneTakeoff },
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "32px" }}>
                        {techCategories.map((cat) => (
                            <div key={cat.category} style={{
                                ...
                                <div style={{ background: "#652b32", padding: "18px 24px" }}>
                                    <span style={{
                                ...
                                <div style={{ padding: "8px" }}>
                                    {cat.items.map((item) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <span style={{ color: "#652b32" }}><item.Icon size={22} strokeWidth={1.8} /></span>
                                                <span style={{ fontSize: "15px", fontWeight: "600", color: "#652b32" }}>{item.name}</span>
                                                {hovered === key && (
