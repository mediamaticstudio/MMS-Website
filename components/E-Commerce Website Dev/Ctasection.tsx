...
const technologies = [
    {
        icon: "🤖", title: "AI-Driven Shopping Experience",
    ...
    {
        icon: "🎙️", title: "Voice-Enabled Product Search",
    ...
    {
        icon: "👗", title: "Digital Fitting Experience",
    ...
    {
        icon: "📡", title: "IoT-Enabled Smart Connectivity",
    ...
    {
        icon: "🥽", title: "eCommerce Solutions for AR & VR",
...
const integrations = [
    {
        icon: "📦", title: "ERP & Inventory Management Systems",
    ...
    {
        icon: "🤝", title: "CRM & Marketing Automation Platforms",
    ...
    {
        icon: "📊", title: "Data Analytics and Business Intelligence",
    ...
    {
        icon: "🚚", title: "Logistics & Shipping API Integrations",
    ...
    {
        icon: "🏪", title: "Marketplaces & Multi-Channel Sales Platforms",
    ...
    {
        icon: "🖥️", title: "POS & In-Store System Integrations",
...
export default function CTASection() {
    ...
    return (
        <>
            ...
            <section ref={s1.ref} style={{ background: "#faf3e0", padding: "5rem 6vw" }}>
                <div style={{
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(320px,1fr))", gap: 0 }}>
                    {[
                        {
                            icon: "🌐", dark: false, title: "How does an e-commerce website help businesses?",
                        ...
                        {
                            icon: "🏢", dark: true, title: "Which Types of Businesses Benefit from an E-commerce Website?",
                        ...
                        <div key={i} style={{
                            ...
                            <h3 style={{
                                ...
                                color: c.dark ? "#faf3e0" : "#652b32", marginBottom: "0.9rem", lineHeight: 1.3,
                            }}>{c.title}</h3>
                            <p style={{
                                fontSize: "0.93rem", lineHeight: 1.8, fontWeight: 300,
                                color: c.dark ? "rgba(250,243,224,0.65)" : "rgba(101,43,50,0.68)",
                            }}>{c.body}</p>
                        </div>
                    ))}
                </div>
            ...
            <section ref={s2.ref} style={{ background: "#652b32", padding: "5rem 6vw" }}>
                <div style={{
                    ...
                    <h2 style={{
                        ...
                        marginBottom: "0.7rem", lineHeight: 1.15,
                    }}>Advanced Technologies Powered to Your E-Commerce Store</h2>
                    <p style={{ fontSize: "0.97rem", color: "rgba(250,243,224,0.57)", maxWidth: "600px", lineHeight: 1.75, marginBottom: "3rem", fontWeight: 300 }}>
                    ...
                    {technologies.map((item, i) => (
                        <div key={i} style={{
                            ...
                            <div style={{
                                ...
                                fontWeight: 900, color: "#f5c518", opacity: 0.2, lineHeight: 1, marginBottom: "0.3rem",
                            }}>0{i + 1}</div>
            ...
            {/* INTEGRATIONS */}
            <section ref={s3.ref} style={{ background: "#faf3e0", padding: "5rem 6vw" }}>
                <div style={{
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: "2px", background: "rgba(101,43,50,0.1)" }}>
                    {integrations.map((item, i) => (
                        <div key={i}
                            ...
                            style={{
                                ...
                                padding: "2.4rem 2rem", cursor: "default",
                                opacity: s3.vis ? 1 : 0, transform: s3.vis ? "translateY(0)" : "translateY(28px)",
                                transition: `background 0.3s ease, opacity 0.6s ease ${i * 0.08}s, transform 0.6s ease ${i * 0.08}s`,
                            }}>
                            <div style={{ fontSize: "1.8rem", marginBottom: "0.8rem" }}>{item.icon}</div>
                            <div style={{
                                width: hovI === i ? "38px" : "0px", height: "2px",
                            ...
                            <div style={{
                                ...
                                marginBottom: "0.55rem", transition: "color 0.3s ease",
                            }}>{item.title}</div>
                            <div style={{
                                fontSize: "0.87rem", lineHeight: 1.75, fontWeight: 300,
                                color: hovI === i ? "rgba(250,243,224,0.6)" : "rgba(101,43,50,0.62)",
