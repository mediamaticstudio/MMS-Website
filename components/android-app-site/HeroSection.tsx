      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          ...
          style={{
            right: "18%",
            background:
              "linear-gradient(180deg, transparent, rgba(245,197,24,0.35), transparent)",
          }}
        />
        <div
          ...
          style={{
            right: "calc(18% + 10px)",
            background:
              "linear-gradient(180deg, transparent, rgba(245,197,24,0.12), transparent)",
          }}
        />
        {/* Dot grid */}
        ...
        <div>
          ...
          <h1
            ...
            style={{
              fontSize: "clamp(44px, 5.5vw, 74px)",
              color: "var(--gold)",
              textShadow: "0 0 80px rgba(245,197,24,0.4)",
            }}
          >
            Apps That Win.
          </h1>
          ...
          <div className="hero-item flex flex-wrap gap-4">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2.5 rounded px-9 py-[17px] text-[15px] font-extrabold transition-all duration-200 hover:-translate-y-1 hover:scale-[1.02] animate-glow-btn"
              style={{
                background: "var(--gold)",
                color: "#3a1518",
            ...
            <Link
              href="/portfolio"
              className="inline-flex items-center gap-2.5 rounded border-2 px-9 py-[17px] text-[15px] font-semibold transition-all duration-200 hover:text-[var(--gold)] hover:border-[var(--gold)]"
              style={{
                borderColor: "rgba(250,243,224,0.28)",
                color: "var(--cream)",
                fontFamily: "var(--font-dm-sans)",
              }}
            >
              ...
              style={
                i === 0
                  ? {
                      ...
                      boxShadow: "0 12px 40px rgba(245,197,24,0.45)",
                    }
                  : {
