...
import { UserCheck, Target, Search, RefreshCw, BarChart3, Briefcase } from "lucide-react";
    ...
    <>
      <section id="why-us" className="why-section">
          ...
          <div className="why-right">
            {whyUs.map((item, i) => (
              <div key={i} className="why-card" style={{ animationDelay: `${i * 0.08}s` }}>
                <div className="why-icon"><item.Icon size={22} strokeWidth={1.8} /></div>
                <div>
        ...
        <style jsx>{`
          ...
          .why-icon { color: #f5c518; flex-shrink: 0; }
          .why-title {
            font-weight: 700;
            color: #faf3e0;
            font-size: 0.95rem;
