    ...
    return (
        <section className="hero-section">
            ...
            <div className="hero-container">
                <div className="hero-badge">📈 #1 Google Ads Agency for Lead Generation</div>
                <h1 className="hero-title">
                    Drive <span className="hero-highlight">Quality Leads</span> with
                    <br />
                ...
                <div className="hero-cta-group">
                    <a href="#contact" className="btn-primary">Grow Your Business with Ads</a>
            ...
            <div ref={floatRef} className="hero-visual">
                ...
                <div className="floating-tag tag-left">
                    <span>✓</span> High-Intent Keywords
                </div>
                <div className="floating-tag tag-right">
                    <span>⚡</span> Instant Traffic
                </div>
            </div>
        ...
        .floating-tag span { font-size: 0.9rem; }
