...
const AboutSection = () => {
    ...
    const features = [
        ...
        },
        {
            icon: Globe,
            title: "Global Reach",
            description: "Scalable applications designed for worldwide audiences",
            color: "secondary"
        },
        {
            icon: Users,
            title: "Collaborative Approach",
            description: "We listen, adapt, and create with your vision in mind",
            color: "accent"
        }
    ];
                    ...
                    >
                        ...
                        <motion.div variants={itemVariants} className="space-y-5">
                            <p className="text-lg text-muted-foreground leading-relaxed font-medium">
                                MediaMatic is a collective of visionary designers and developers who stay ahead of digital trends to elevate your brand's online presence.
                            </p>
                            <p className="text-muted-foreground leading-relaxed">
                                We're thinkers, experienced website designers, top-tier developers, and tech enthusiasts dedicated to crafting exceptional websites, mobile applications, and e-commerce platforms.
                            </p>
                            <div className="relative group">
                                ...
                                <div className="relative bg-gradient-to-r from-primary/5 to-secondary/5 rounded-2xl p-6 border border-primary/10 group-hover:border-primary/20 transition-colors">
                                    <p className="text-foreground font-semibold italic leading-relaxed text-lg">
                                        "MediaMatic listens to you, adapts to you, and collaborates with you to create your unique digital identity."
                                    </p>
                                </div>
                            </div>
                        </motion.div>
                                ...
                                >
                                    ...
                                    <div className="relative p-3 rounded-xl bg-secondary/30 backdrop-blur-sm border border-secondary/50 group-hover:border-primary/30 transition-colors">
                                        <div className="flex items-center gap-3">
                                            <div className={`flex-shrink-0 w-10 h-10 rounded-lg bg-${feature.color}/20 flex items-center justify-center group-hover:scale-110 transition-transform`}>
                        ...
                        >
                            ...
                            <div className="relative bg-gradient-to-br from-primary/5 via-background to-secondary/5 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-primary/10 group-hover:border-primary/30 transition-all duration-300">
                                ...
                                <p className="text-muted-foreground leading-relaxed ml-16 font-medium">
                                    Web application development creates strong, user-focused web applications with fluid interactions across devices. Smart front-end design and sturdy back-end architecture boost business productivity and consumer engagement.
                                </p>
                        ...
                        >
                            ...
                            <div className="relative bg-gradient-to-br from-secondary/5 via-background to-primary/5 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-secondary/10 group-hover:border-secondary/30 transition-all duration-300">
                                <div className="flex items-start gap-4 mb-4">
                                    ...
                                    <h3 className="text-xl font-bold text-foreground flex-1 leading-tight">
                                        How does a website drive business success?
                                    </h3>
                                </div>
                                <p className="text-muted-foreground leading-relaxed ml-16 font-medium">
                                    As website app developers, we specialize in dynamic, scalable web applications personalized to deliver improved business results. From custom portals to interactive eCommerce platforms, our solutions cater to global audiences while meeting your revenue objectives.
                                </p>
                                <div className="mt-4 ml-16 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <a href="#" className="inline-flex items-center gap-1 text-sm font-semibold text-secondary-foreground hover:gap-2 transition-all">
