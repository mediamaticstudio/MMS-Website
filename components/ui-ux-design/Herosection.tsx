  ...
  return (
    ...
    >
      ...
      {[
        ...
        { icon: Palette, top: "25%", right: "14%", size: 20, color: "#652b32", delay: "0.5s" },
      ...
      >
        ...
        <div>
          ...
          >
            In the current competitive digital environment, a fantastic design is not just a visual one, but it is composed of meaningful user experiences which result in engagement and conversions.
          </p>
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            ...
            >
              Intuitive. Appealing. High-performing digital platforms for every
              business.
            </div>
