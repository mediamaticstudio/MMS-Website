            ...
            <div className="container mx-auto px-6 md:px-12">
                ...
                {isLoading ? (
                    ...
                    <div className="text-center py-20 border-2 border-dashed border-[#652b32]/10 rounded-3xl">
                        <p className="text-[#652b32]/60 font-medium mb-4 uppercase tracking-widest text-[10px]">Failed to load stories</p>
                        <Link 
                            href="/blog"
                            className="text-[#652b32] font-black uppercase tracking-widest text-[10px] underline decoration-2 underline-offset-4 hover:opacity-70 transition-all"
                        >
                            Try visiting the blog directly
                        </Link>
                    </div>
                ) : (
