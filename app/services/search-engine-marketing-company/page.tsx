    ...
    return (
        <div className="min-h-screen bg-background font-body">
            <SEO
                ...
                canonical="/services/search-engine-marketing-company/"
                structuredData={[
                    generateBreadcrumbSchema([
                        { name: "Home", url: "/" },
                        { name: "Services", url: "/services/" },
                        { name: "Digital Marketing", url: "/services/digital-marketing-agency/" },
                        { name: "SEM", url: "/services/search-engine-marketing-company/" }
                    ]),
                    generateServiceSchema({
                        name: "Search Engine Marketing (SEM) Services",
                        description: "Professional PPC, Google Ads, and paid media management services for instant visibility and ROI."
                    }),
