    ...
    return (
        <div className="min-h-screen bg-background font-body">
            <SEO
                ...
                structuredData={[
                    generateBreadcrumbSchema([
                        ...
                        { name: "SEO", url: "/services/search-engine-optimization-company/" }
                    ]),
            ...
            <section className="relative overflow-hidden py-16 md:py-24 px-4 bg-[#652b32] text-[#faf3e0]">
                ...
                <div className="absolute bottom-8 left-12 opacity-15 pointer-events-none">
                ...
                <div className="container mx-auto max-w-4xl relative z-10">
                    <motion.div
                        ...
                        transition={{ duration: 0.7 }}
                    >
                        <h2 className="text-3xl md:text-5xl font-bold text-[#faf3e0] leading-tight mb-6 font-display">
